		...
		OptionParser parser = new OptionParser() {
			{
				...
				acceptsAll(asList("sharkpigot", "sharkpigot-settings"), "File for sharkpigot settings").withRequiredArg()
				.ofType(File.class).defaultsTo(new File("sharkpigot.yml")).describedAs("Yml file");
				// WindSpigot end
			}
		};
