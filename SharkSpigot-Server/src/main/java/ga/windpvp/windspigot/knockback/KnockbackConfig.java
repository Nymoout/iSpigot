...
public class KnockbackConfig {
	...
	private static final String HEADER = "This is the knockback configuration file for SharkSpigot.\n"
	...
	public static void init(File configFile) {
		...
		try {
			WindSpigot.LOGGER.info("Loading SharkSpigot knockback config from " + configFile.getName());
